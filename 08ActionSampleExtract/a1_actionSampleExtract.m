...
%sampleCategory = 10;
userNum = 'user5';
saveDir = ['20200115ActionMatPerFile/',userNum,'_data_label']; %'20191220SegmentTrainNew/user2_data_label';
%whetherPlot = 0;
...
cvsSegment = csvread(['20200104ManualSegment200/',userNum,'ManualSegment.csv']);% '20191212ManualSegment/user1ManualSegment.csv'
dirMat = ['20200104OriginalMatDataCut\',userNum];  %'20191211OriginalMatData\user2'
